...
echo -e "${CYAN}"
echo "################################################################"
echo "# Start downloading and installing  quicksignalmodedbyiet5_2.2 #"
echo "#####################################################$$$$$$$####"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/211/refs/heads/main/enigma2-plugin-extensions-quicksignalmodedbyiet5_2.2_all.ipk"
IPK_NAME="enigma2-plugin-extensions-quicksignalmodedbyiet5_2.2_all.ipk"
